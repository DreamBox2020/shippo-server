...
CREATE TABLE `shippo_passport` (
                                   ...
                                   `wx_passport_id` bigint unsigned DEFAULT NULL,
                                   PRIMARY KEY (`id`),
...
CREATE TABLE `shippo_wx_article` (
                                     ...
                                     `image2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文章封面2.35:1',
...
CREATE TABLE `shippo_wx_offiaccount` (
                                         `id` int unsigned NOT NULL AUTO_INCREMENT,
                                         `created_at` datetime DEFAULT NULL,
                                         `updated_at` datetime DEFAULT NULL,
                                         `deleted_at` datetime DEFAULT NULL,
...
CREATE TABLE `shippo_wx_passport` (
                                      ...
                                      UNIQUE KEY `mini_program_open_id` (`mini_program_open_id`) USING BTREE,
                                      UNIQUE KEY `offiaccount_open_id` (`offiaccount_open_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
